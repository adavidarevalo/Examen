    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-1">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal_peliculas"
                    id="btn_nuevo">
                    Nueva Pelicula
                </button>
            </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="filtroTituloHeader">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#filtroTituloCollapse" aria-expanded="true"
                                    aria-controls="filtroTituloCollapse">
                                    Filtros
                                </button>
                            </h2>
                            <div id="filtroTituloCollapse" class="accordion-collapse collapse show"
                                aria-labelledby="filtroTituloHeader" data-bs-parent="#filtersAccordion">
                                <div class="accordion-body">

                                    <div class="row">
                                        <div class="card w-100">
                                            <div class="form-group" class="mb-5" style="margin-bottom: 10px;">
                                            ...
                                            <div class="form-group" class="mb-5" style="margin-bottom: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <select name="Genero_filter" id="Genero_filter" class="form-control"
                                                        class="ID_cine" disabled={true}></select>
                                            ...
                                            <div class="form-group" class="mb-5" style="margin-bottom: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <select name="Cine_filter" id="Cine_filter" class="form-control"
                                                        class="ID_cine" disabled={true}></select>
                                            ...
                                            <div class="form-group" class="mb-5" style="margin-bottom: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <select name="Ciudad_filter" id="Ciudad_filter" class="form-control"
                                                        class="ID_cine" disabled={true}></select>
...
<!-- Modal -->
<div class="modal fade" id="Modal_peliculas" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" id="myTabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="general-tab" data-bs-toggle="tab" href="#general">Nueva
                            Pelicula</a>
                    </li>
                    ...
                    <div class="tab-pane fade show active" id="general">
                        <form method="post" id="form_pelicula">
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <input type="text" required class="form-control" id="Título" name="Título"
                                    placeholder="Título">
                            </div>
                            ...
                            <div style="margin-bottom: 10px;">
                                ...
                                <button type="button" class="btn btn-outline-secondary" id="mostrarInput">
                                   ...
                                   <div style="margin-bottom: 10px;">
                                     <div id="inputContainer" style="display: none;" class="input-group mt-2">
                                        <input type="text" class="form-control" id="nuevaCiudad"
                                            placeholder="Nueva Genero">
                                ...
                                <div class="form-group" style="margin-bottom: 10px;">
                                    ...
                                    <input type="text" required class="form-control" id="Duración" name="Duración"
                                        placeholder="Duración">
                                </div>
                                <div class="form-group" id="Cine_field" style="margin-bottom: 10px;">
...
<div class="modal fade" id="Modal_ver_pelicula" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
