      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Cines/cines.php" target="base" aria-expanded="false">
                <span>
                  <i class="ti ti-alert-circle"></i>
                </span>
                <span class="hide-menu">Cines</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="Peliculas/peliculas.php" target="base"  aria-expanded="false">
                <span>
